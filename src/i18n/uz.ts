export const uz = {
  brandTagline: "Restorani yuritish uchun kerakli hamma narsa — bir joyda",

  navFeatures: "Ilovalar",
  navPricing: "Narxlar",
  navFaq: "FAQ",
  ...
  heroMetricDowntimeCopy:
    "Raqamli stol boshqaruvi va zudlik bilan oshxona tiketlari tiqilinchlarni kamaytiradi va kutish vaqtini qisqartiradi.",
  ...
  mobileHighlightsFeaturesBody:
    "POS’da berilgan buyurtma darhol Kitchen’da ko‘rinadi va Dash’dagi zaxiralarni yangilaydi — ortiqcha qadam yo‘q.",

  mobileHighlightsPricingTag: "Qiymat",
  mobileHighlightsPricingTitle: "Bitta narx — hammasi ichida",
  mobileHighlightsPricingBody:
    "Uch ilova, barcha funksiyalar, barcha yangilanishlar — oylik yagona to‘lov.",
  ...
  mobileContactSub: "Telefon yoki email orqali aloqada bo‘ling",
  ...
  howStep1Body:
    "Pozitsiyalarni qo‘shing, zal rejasini chizing va xodim ruxsatlarini bitta joydan belgilang.",

  howStep2Tag: "Ulang",
  howStep2Title: "POS’ni ishga tushiring",
  howStep2Body:
    "Jamoa sodda grid interfeysi orqali darhol buyurtma qabul qila boshlaydi.",

  howStep3Tag: "Pishiring",
  howStep3Title: "Kitchen’ni faollashtiring",
  howStep3Body:
    "Oshxona displeyini o‘rnating va buyurtmalar kechikmasdan oqishini kuzating.",
  ...
  testimonialsCard1Quote:
    '"Zalning vizual rejasi qayerda servis kerakligini darhol ko‘rsatadi. Tezligimiz ancha oshdi."',
  testimonialsCard1Author: "Alex M",

  testimonialsCard2Tag: "Oshxona menejeri",
  testimonialsCard2Quote:
    '"Stansiyalar bo‘yicha marshrutlash hammasini o‘zgartirdi. Ichimliklar barга, taomlar oshxonaga boradi — chalkashlik va qichqiriq yo‘q."',
  testimonialsCard2Author: "Sarah J",

  testimonialsCard3Tag: "General menejer",
  testimonialsCard3Quote:
    '"Dash hisobotlari aynan keraklisini beradi — foyда, eng yaxshi sotuvlar va trendlar. Judayam foydali."',
  testimonialsCard3Author: "David L",

  testimonialsCard4Tag: "Operatsiyalar",
  testimonialsCard4Quote:
    '"Inventar oldin soatlar olardi. Endi ish jarayonida avtomatik yangilanadi."',
  testimonialsCard4Author: "Maria R",

  testimonialsCard5Tag: "Ega",
  testimonialsCard5Quote:
    '"Oyiga $30 evaziga bu tizim besh barobar qimmatlardan ham ko‘proq qiymat beradi."',
  testimonialsCard5Author: "James K",

  pricingBadge: "Narxlar",
  pricingHeading: "Bitta shaffof obuna",
  pricingBody:
  ...
  pricingStarterBody:
    "Tizimning to‘liq imkoniyatlaridan o‘z ma’lumotlaringiz bilan foydalaning.",
  pricingStarterB1: "Dash, POS va Kitchen — to‘liq kirish",
  pricingStarterB2: "Cheksiz pozitsiya va tranzaksiyalar",
  pricingStarterB3: "Jonli hisobotlar",
  pricingStarterB4: "Inventarni kuzatish",
  pricingStarterB5: "Demo uchun karta talab qilinmaydi",
  ...
  pricingEnterpriseHeading: "Franshiza yuritasizmi?",
  pricingEnterpriseBody:
    "Barcha joylar bo‘yicha menyu, inventar va hisobotlarni markazlashtiring.",
  pricingEnterpriseCta: "Sotuv bilan bog‘lanish",

  pricingImplementTag: "Mos onboarding kerakmi?",
  pricingImplementHeading: "Sozlashda yordam kerakmi?",
  pricingImplementBody:
    "Menyuni raqamlashtirish, zal rejasini chizish va xodimlarni o‘qitishda yordam beramiz.",
  pricingImplementB1: "Menyu raqamlashtirish xizmati",
  pricingImplementB2: "Uskuna bo‘yicha tavsiyalar",
  ...
  wizardNameLabel: "To‘liq ism",
  wizardNamePlaceholder: "masalan, John Doe",
  wizardBusinessLabel: "Restoran nomi",
  wizardBusinessPlaceholder: "masalan, The Burger Joint",
  wizardLocationsLabel: "Joylar soni",
  wizardLocationsOption1: "1",
  wizardLocationsOption2: "2-5",
  wizardLocationsOption3: "5+",
  wizardLocationsOption4: "Franshiza",
  wizardCurrentPosLabel: "Joriy tizim (bo‘lsa)",
  wizardCurrentPosPlaceholder: "masalan, Qog‘oz-qalam, Excel, Micros",
  wizardPhoneLabel: "Telefon raqami",
  wizardPhonePlaceholder: "+998 90 000 00 00",
  wizardEmailLabel: "Email manzil",
  ...
  wizardServiceStyleLabel: "Qaysi xizmat uslubi mos keladi?",
  wizardServiceStyleOption0: "Uslubni tanlang...",
  wizardServiceStyleOptionCafe: "Kafe / Kofe",
  wizardServiceStyleOptionBistro: "Bistro / Casual",
  wizardServiceStyleOptionQuick: "Tez xizmat (Fast Food)",
  wizardServiceStyleOptionFull: "To‘liq servis",
  wizardServiceStyleOptionBar: "Bar / Klub",
  wizardServiceStyleOptionMarket: "Chakana / Market",
